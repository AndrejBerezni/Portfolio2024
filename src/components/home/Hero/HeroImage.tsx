...
export default function HeroImage() {
  return (
    <AnimationFadeIn styles="flex aspect-square h-[240px] w-[240px] items-center justify-center rounded-full border-2 border-brand shadow-md sm:h-[400px] sm:w-[400px] xl:h-[540px] xl:w-[540px]">
      <Image
        src="/andrej.png"
