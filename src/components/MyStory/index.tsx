  ...
  return (
    <section className="my-24 md:my-36">
      ...
      <p className="mb-6 mt-8 text-lg md:mt-16 md:text-2xl">
        ...
        the way, I&apos;ve always been curious about how things work, especially
        in development. I found that web development really lets me flex my
      ...
      <p className="my-6 text-lg md:text-2xl">
        ...
        never stops in this field, and I&apos;m always picking up new things and
        getting better at what I already know.
      </p>
      <p className="mb-16 mt-6 text-lg md:text-2xl">
        With just over a year of experience in development, I&apos;m excited to
        keep growing as a <span className="text-brand">web developer</span>.
